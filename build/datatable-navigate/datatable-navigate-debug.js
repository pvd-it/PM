...
YUI.add('datatable-navigate', function(Y) {
	...
	Y.DataTableNavigate = Y.Base.create('datatable', Y.DataTable, [Y.DataTable.EventBindings], {
		...
		initializer : function() {
			Y.log('Y.DataTableNavigate.initializer');
		...
		*/
		_afterRenderUINavigate : function() {
			Y.log('Y.DataTableNavigate._afterRenderUINavigate');
		...
		*/
		_afterFocusNavigate : function() {
			Y.log('Y.DataTable.Navigate._afterFocusNavigate');
		...
		_afterSyncUINavigate : function() {
			Y.log('Y.DataTableNavigate._afterSyncUINavigate');
		...
		_uiSetActiveRow : function(trOldNode, trNewNode) {
			Y.log('Y.DataTableNavigate._uiSetActiveRow');
		...
		_uiSetActiveCell : function(tdOldNode, tdNewNode) {
			Y.log('Y.DataTableNavigate._uiSetActiveCell');
			Y.log('tdOldNode: ' + tdOldNode);
			Y.log('tdNewNode: ' + tdNewNode);
		...
		*/
		setAsActiveCell: function(cellTd){
            Y.log('Y.DataTableNavigate.setAsActiveCell');
		...
		*/
		_mouseDownHandler: function(e){
			Y.log('Y.DataTableNavigate._mouseDownHandler');
