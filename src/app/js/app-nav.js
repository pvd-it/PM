...
YUI.add('app-nav', function(Y){
	...
	Nav.prototype =	{
		...
		_setupNav: function(){
			 ...
			 * 2. User is trying to open the application from another browser tab, after successfully logging into the application from
			 * another tab
			 */
		...
		_afterCurrentProjectChangeNav: function(e){
			...
			self.secondaryNav.one('.project-name > a').set('innerHTML', '<i class="icon-gift"> </i> ' +
															e.newVal.get('name') +
															'<b class="caret"></b>');
