...
function program16(depth0,data) {
  ...
  if (!helpers.days) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(17, program17, data)}); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n							";
  return buffer;}
function program17(depth0,data) {
  ...
  if (!helpers.months) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(1, program1, data)}); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n					</tr>\n					<tr>\n						";
  foundHelper = helpers.months;
  ...
  if (!helpers.months) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(6, program6, data)}); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n					</tr>\n				</tbody>\n			</table>\n		</div>\n	</div>\n	<div class=\"movable-body\">\n		<div class=\"unmovable-cols\">\n			<table class=\"table table-bordered table-condensed\">\n				<tbody>\n					";
  ...
  if (!helpers.tasks) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(9, program9, data)}); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n				</tbody>\n			</table>\n		</div>\n		<div id=\"body-scrollview-content\" class=\"yui3-scrollview-loading\">\n			<div class=\"task-bars movable-rows\">\n				<table class=\"table table-bordered table-condensed\">\n					<tbody>\n						";
  foundHelper = helpers.tasks;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{},inverse:self.noop,fn:self.program(11, program11, data)}); }
  else { stack1 = depth0.tasks; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  if (!helpers.tasks) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(11, program11, data)}); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  if (!helpers.months) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(16, program16, data)}); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n							</tr>\n						</tbody>\n					</table>\n				</div>\n			</div>\n		</div>\n	</div>\n</div>";
  return buffer;};
