YUI.add('app-base-fix', function(Y) {
	...
	AppBaseFix.prototype = {
		_uiSetActiveView : function(newView, oldView, options) {
			...
			var callback = options.callback, isChild = this._isChildView(newView, oldView), isParent = !isChild && this._isParentView(newView, oldView), prepend = !!options.prepend || isParent;
